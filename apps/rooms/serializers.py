...
class RoomTypeSerializer(serializers.ModelSerializer):
    ...
    infant_without_bed_price = serializers.SerializerMethodField()
    ...
    def get_infant_without_bed_price(self, obj):
        rp = self._get_room_price(obj)
        return str(rp.infant_without_bed_price) if rp and rp.infant_without_bed_price else None
